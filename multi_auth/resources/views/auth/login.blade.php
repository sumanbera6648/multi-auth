                ...
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link">New Here? <a href="{{ route('register') }}">Create an account</a></p>
                            ...
                            <form class="from" method="POST" action="{{ route('login') }}">
                                @csrf
                                ...
                                <div class="field-wrapper text-center keep-logged-in" id="username-field">
                                    <div class="n-chk new-checkbox checkbox-outline-primary">
                                        <label class="new-control new-checkbox checkbox-outline-primary">
                                          <input type="checkbox" class="new-control-input" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                                          <span class="new-control-indicator" for="remember"></span>Keep me logged in
                                        </label>
                                    </div>
                                </div>

        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                    {{-- <li class="active">
                        <a href="{{route('home')}}"> Sales </a>
                    </li>
                    <li class="active">
                        <a href="{{route('use')}}"> Users </a>
                    </li> --}}
...
{{-- 
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="banner" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('banner.index')}}">Banner Table </a>
                    </li>
                    <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="brand" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('brand.index')}}"> Brand Table</a>
                    </li>
                    <li>
            ...
            <li class="menu">
                <a href="#post-cat" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="post-cat" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('postcategory.index')}}"> Category Table</a>
                    </li>
                    <li>
                        <a href="{{route('postcategory.create')}}"> Add Category </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                <a href="#tag" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                        <span>Post Tag</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="tag" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('posttag.index')}}"> Category Table</a>
                    </li>
                    <li>
                        <a href="{{route('posttag.create')}}"> Add Category </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="post" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('post.index')}}"> Post Table</a>
                    </li>
                    <li>
            ...
            <li class="menu">
                <a href="#shipping" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                        <span>Shipping</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="shipping" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('shipping.index')}}"> Shipping Table</a>
                    </li>
                    <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="coupon" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('coupon.index')}}"> Coupon Table</a>
                    </li>
                    <li>
            ...
            <li class="menu">
                <a href="#message" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                        <span>Message</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="message" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('message.index')}}"> Message Table</a>
                    </li>
                    <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="order" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('order.index')}}"> order Table</a>
                    </li>
                    <li>
